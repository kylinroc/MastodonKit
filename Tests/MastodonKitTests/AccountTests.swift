...
final class AccountTests: XCTestCase {
    func testDecoding() {
        ...
        XCTAssertEqual(account.headerURL, URL(string: "https://files.mastodon.social/accounts/headers/000/023/634/original/256eb8d7ac40f49a.png"))
        XCTAssertFalse(account.locked)
        XCTAssertEqual(account.creationDate, Client.dateFormatter.date(from: "2017-02-08T02:00:53.274Z"))
